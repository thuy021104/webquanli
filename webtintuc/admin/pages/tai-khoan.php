<?php 
    ...
    if(isset($_SESSION['user']) && $_SESSION['level']==1)
    {
        ...
        {
            $id=$_GET['id'];
            $del = "DELETE FROM account WHERE id_acc = $id";
...
<body>
    ...
    ?>
                                                <tr>
                                                    ...
                                                    <td><a href="sua-taikhoan.php?id=<?php echo $row_acc['id_acc']; ?>" class="btn btn-info"><i class="fas fa-pen-nib"></i></a></td>
                                                    <td><a href="tai-khoan.php?id=<?php echo $row_acc['id_acc']; ?>" onclick="return confirm('Dữ liệu này sẽ được xóa vĩnh viễn. Đồng ý?');" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a></td>
                                                </tr>
    <?php 
        }
        // end while
