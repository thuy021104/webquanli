<?php 
    ...
    if(isset($_SESSION['user']) && isset($_SESSION['level']))
    {
        ...
        {
            $id = $_GET['id'];
            $sql = "SELECT * FROM bai_viet WHERE id_blog = $id";
        ...
        if(isset($_POST['upload']))
        {
            ...
            if($image)
            {
                ...
                {
                    echo "<script>alert('Vui lòng nhập tiêu đề bài giảng');</script>";
                }
            }
            else
            {
                ...
                <div class="container-fluid dashboard-content " >
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header" >
                                <h2 class="pageheader-title" style="font-family: 'Roboto Condensed', sans-serif;">Bài giảng mới</h2>
                                <!--
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa bài giảng</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="ecommerce-widget">
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header" style="font-family: 'Roboto Condensed', sans-serif;">Chỉnh sửa bài giảng</h5>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label>Chọn loại bài giảng:</label>
                                                    <select class="form-control" name="id_type">

                                <?php 

                                    // show type blog
                                    $active = "SELECT tb.id_type as id_type, typename FROM bai_viet b, loai_bai_viet tb WHERE b.id_type = tb.id_type AND b.id_blog = $id";
                                ...
                                <?php 
                                    // show type blog
                                    $type_op = "SELECT id_type, typename FROM loai_bai_viet WHERE id_type <> $id_active";
