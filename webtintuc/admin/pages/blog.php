<?php
    ...
    if(isset($_SESSION['user']) && isset($_SESSION['level']))
    {
        ...
        if(isset($_GET['id']))
        {
            ...
            $id = $_GET['id'];
            $sql = "SELECT image, title FROM bai_viet WHERE id_blog = $id";
            ...
            $del = "DELETE FROM bai_viet WHERE id_blog = $id";
                ...
                <div class="container-fluid dashboard-content " >
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header" >
                                <h2 class="pageheader-title" style="font-family: 'Roboto Condensed', sans-serif;">Danh sách bài viết</h2>
                                <!--
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <?php
                            ...
                            if($level == 1)
                            {
                                $blog = "SELECT id_blog, image, title, date_upload, b.slug as slug, typename, flag FROM bai_viet b, loai_bai_viet tb WHERE b.id_type = tb.id_type ORDER BY date_upload DESC";
                        ...
                        <?php
                            ...
                            {
                                $blog2 = "SELECT id_blog, b.image as image, title, date_upload, b.slug as slug, typename, flag FROM bai_viet b, loai_bai_viet tb, account a WHERE b.id_type = tb.id_type AND a.id_acc = b.author AND email = '$users' ORDER BY date_upload DESC";
