            ...
            if($image)
            {
                if($title)
                {
                    ...
                    else
                    {
                        ...
                        // add new record
                        $ins = "INSERT INTO bai_viet(image, title, slug, summary, content, date_upload, author, highlight, view, flag, id_type) VALUES('".$name_code."', '".$title."', '".$slug."', '".$summary."', '".$content."', '".$date_upload."', '".$author."', ".$highlight.", ".$view.", ".$flag.", ".$id_type.")";
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <?php 
                                    ...
                                    // show type blog
                                    $type_op = "SELECT id_type, typename FROM loai_bai_viet";
