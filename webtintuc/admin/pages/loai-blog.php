    ...
    if(isset($_SESSION['user']) && isset($_SESSION['level']))
    {
        ...
        if(isset($_POST['save']))
        {
            ...
            if($name_type)
            {
                ...
                // insert data
                $ins = "INSERT INTO loai_bai_viet(typename, slug_type, date_create) VALUES('$name_type', '$slug', '$date_create')";
        ...
        if(isset($_GET['id']))
        {
            ...
            // get data
            $data = "SELECT id_type, typename FROM loai_bai_viet WHERE id_type = $id";
            $rs_data = mysqli_query($conn, $data);
            $row_data = mysqli_fetch_array($rs_data);
            $delname = $row_data['typename'];
            $id_type = $row_data['id_type'];

            // remove image and image bai_viet of type
            $blog = "SELECT image FROM bai_viet WHERE id_type = $id_type";
            ...
            while ($row_blog = mysqli_fetch_array($rs_blog))
            {
                ...
                // delete record blog
                $del_blog = "DELETE FROM bai_viet WHERE id_type = $id_type";
            ...
            $del = "DELETE FROM loai_bai_viet WHERE id_type = $id";
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                            ...
                            <?php
                                ...
                                $typeb = "SELECT * FROM loai_bai_viet ORDER BY typename DESC";
