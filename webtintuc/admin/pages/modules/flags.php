<?php
	...
	if(isset($_GET['id']) && isset($_GET['tbl']))
	{
		...
		{
			// get flag
			$sql = "SELECT flag, title FROM bai_viet WHERE id_blog = $id";
			...
			if($flag == 1)
			{
                ...
                // update flag
				$update = "UPDATE bai_viet SET flag = 0 WHERE id_blog = $id";
			...
			else
			{
                ...
                // update flag
				$update = "UPDATE bai_viet SET flag = 1 WHERE id_blog = $id";
				mysqli_query($conn, $update);
				echo "<script>location.href='../blog.php';</script>";
			}
		}
